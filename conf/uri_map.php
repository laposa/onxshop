...
$uri_map = array(
    ...
    '^/backoffice' => array(
        ...
        '^/backoffice/node/([0-9]*)$' => '/index.php?request=sys/html5.bo/backoffice_wrapper.bo/backoffice.bo/pages/generic.bo/component/node_edit~id=$1~',
        ...
        '^/backoffice/advanced/database/graphql$' => '/index.php?request=sys/html5.bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/database_graphql',
